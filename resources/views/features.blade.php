    ...
    <nav class="bg-white dark:bg-gray-800 shadow-lg" x-data="{ open: false }">
        ...
        <div x-show="open"
            ...
            <div class="px-4 py-6 space-y-4">
                ...
                <a href="{{ route('features') }}" class="block text-blue-600 dark:text-blue-400 font-semibold py-2">{{ __('features') }}</a>
                ...
                <div class="pt-4 border-t border-gray-200 dark:border-gray-700">
                    <div class="flex items-center justify-between">
                        <span class="text-gray-600 dark:text-gray-300">{{ __('language') }}</span>
                        <div class="flex space-x-2">
                            <a href="{{ route('locale.change', 'it') }}" class="text-sm text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400">IT</a>
                            <a href="{{ route('locale.change', 'en') }}" class="text-sm text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400">EN</a>
                            <a href="{{ route('locale.change', 'de') }}" class="text-sm text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400">DE</a>
                            <a href="{{ route('locale.change', 'fr') }}" class="text-sm text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400">FR</a>
                        </div>
                    </div>
                </div>
