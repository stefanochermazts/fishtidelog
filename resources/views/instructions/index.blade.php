        ...
        <div x-show="open"
            ...
            <div class="px-4 py-6 space-y-4">
                ...
                <div class="pt-4 border-t border-gray-200 dark:border-gray-700 space-y-3">
                    <a href="{{ route('login') }}" class="block w-full text-center bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white py-2 rounded-lg font-medium transition-colors">
                        {{ __('messages.login') }}
                    </a>
                    <a href="{{ route('register') }}" class="block w-full text-center bg-blue-600 hover:bg-blue-700 text-white py-2 rounded-lg font-medium transition-colors">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden">
                        ...
                        <div class="px-6 py-6">
                            <div class="prose prose-lg dark:prose-invert max-w-none">
                                {!! $instruction->getLocalizedContent() !!}
                            </div>
                        </div>
                    </div>
                @empty
            ...
            <div class="mt-12 text-center">
                <div class="bg-blue-900 rounded-xl p-8">
                    ...
                    <p class="text-blue-100 mb-6">
                        {{ __('messages.start_tracking_journey') }}
                    </p>
                    <div class="flex flex-col sm:flex-row gap-4 justify-center">
                        <a href="{{ route('register') }}" class="bg-white text-blue-900 px-6 py-3 rounded-lg font-semibold hover:bg-blue-50 transition-colors shadow-lg">
                            {{ __('messages.register_now') }}
                        </a>
                        <a href="{{ route('features') }}" class="border-2 border-white text-white px-6 py-3 rounded-lg font-semibold hover:bg-white hover:text-blue-900 transition-colors">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                <p class="text-gray-400">
                    &copy; {{ date('Y') }} FishTideLog. {{ __('messages.all_rights_reserved') }}
                </p>
            </div>
        </div>
    </footer>
